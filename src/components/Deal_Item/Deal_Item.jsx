...
const Deal_Item = ({ img, name, discount, end_date, active, code }) => {
    ...
    return (
        <div className='col-xl-6'>
            <div className='coupon_container flex border h-full'>
                <div className='flex'>
                    <div className='w-[120px] h-[120px] m-6 cursor-pointer'><img className='w-full h-full object-fill' src={img} alt="" /></div>
                ...
                <div className='coupon_code flex flex-col justify-center items-start gap-3 px-2'>
